...
* Setup my existing blogs to to wordpress docker
  


**Thoughts:**

I’ve been using a lot the docker lately since that’s the thing that I’m currently learning. It’s crazy that I wanted to move all of my existing projects to it. And some of the clients wp sites that I’m managing on my one vps site. As of the moment I have 3 small ditigital ocean node. Which I’m planning to move to one VPS so that I just need to manage one server.

**Explorations:**
It seems I’ve reached the point where I need to managed all of the containers in just one VPS in Digital Ocean. This is something that I’ve really curious about on how to really manage it.

It was really nice to guide your learnings with your curiosity. I just try to learned something if I really need it to be able to solve particular problem that I have.

This leads me to discovering about the traefic that manages all of the containers and doing the reverse proxy stuff. Kinda like the nginx reverse proxy. I still not yet try this and just scan for now the documents.

I’m learning this ‘cause in the upcoming days I will be setting up some of my personal site which is static and some wordpress sites plus I’m planning to explore the ghost as my blogging platform for writing some long form technical stuff.

Learning docker seems overkill at the beginning but it seems it will be really useful to those things that I’m using. Maybe I will try to blog as well if I’m manage to succesfully setups my own infrastructure. I know a lot of developer hate devops ‘cause it was kinda complicate but I start to like to it. haha