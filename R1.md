...
One thing that I would like to know in using docker is how to create a separate files or configs for local developments and productions development.

Things I would like to play around later:

* Plus I wanted to know on how to setups Continous Developments—Where if I merge codes in git master branch It would be able to automatically triggers codes on the my server.
